...
Login_frame.place(x=800,y=250)
        
logolbl=tk.Label(Login_frame,text="Login Here",font=("Algerian", 30, "bold","italic"),bd=5,bg="#333333",fg="white").grid(row=0,columnspan=2,pady=20)
        
lbluser=tk.Label(Login_frame,text="Username", compound=LEFT,font=("Times new roman", 20, "bold"),bg="#333333",fg="white").grid(row=1,column=0,padx=20,pady=10)
txtuser=tk.Entry(Login_frame,bd=0,textvariable=username,font=("",15))
txtuser.grid(row=1,column=1,padx=20)
        
lblpass=tk.Label(Login_frame,text="Password", compound=LEFT,font=("Times new roman", 20, "bold"),bg="#333333",fg="white").grid(row=2,column=0,padx=50,pady=10)
txtpass=tk.Entry(Login_frame,bd=0,textvariable=password,show="*",font=("",15))
txtpass.grid(row=2,column=1,padx=20)
        
btn_log=tk.Button(Login_frame,text="Login",command=login,width=15,font=("Times new roman", 14, "bold"),bg="#333333",fg="white", bd=1)
btn_log.grid(row=3,column=1,pady=10)
btn_reg=tk.Button(Login_frame,text="Create Account",command=registration,width=15,font=("Times new roman", 14, "bold"),bg="#333333",fg="white", bd=1)
